...
namespace TodoListClient.Services
{
    ...
    public class TodoListService : ITodoListService
    {
        ...
        public async Task<Todo> AddAsync(Todo todo)
        {
            ...
            var response = await this._httpClient.PostAsync($"{ _TodoListBaseAddress}/todolist", jsoncontent);
        ...
        public async Task DeleteAsync(int id)
        {
            ...
            var response = await this._httpClient.DeleteAsync($"{ _TodoListBaseAddress}/todolist/{id}");
        ...
        public async Task<Todo> EditAsync(Todo todo)
        {
            ...
            var response = await _httpClient.PatchAsync($"{ _TodoListBaseAddress}/todolist/{todo.Id}", jsoncontent);
        ...
        public async Task<Todo> GetAsync(int id)
        {
            ...
            var response = await _httpClient.GetAsync($"{ _TodoListBaseAddress}/todolist/{id}");
            if (response.StatusCode == HttpStatusCode.OK)
            {
                var content = await response.Content.ReadAsStringAsync();
